...
>
> **Tracking ClickHouse.** The `clickhouse-main` branch holds `ClickHouse/clickhouse-go`'s `main` verbatim. To take a new version: add ClickHouse as a remote, fetch it, rebase these two commits on top, run the tests, tag.
>
